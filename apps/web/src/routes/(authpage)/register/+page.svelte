		...
		>
			...
			<div class="flex flex-col items-center justify-center px-8 text-center">
				<div class="form-container w-full max-w-2xl">
					...
					<p class="mt-2 text-muted-foreground">Let’s get started with your 30 day free trial.</p>
					<form class="mt-8 space-y-6" method="POST">
						<div class="space-y-2">
							...
							<div class="relative">
								...
								/>
								<Input id="name" placeholder="John Doe" name="name" class="pl-9" required />
							</div>
						</div>
						...
						<!-- Primary CTA -->
						<Button class="w-full rounded-full py-6 text-base" type="submit">Create account</Button>
